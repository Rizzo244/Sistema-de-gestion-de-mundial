...
namespace Dominio
{
    public class Sistema
    {
        ...
        private Partido GetPartido(int id)
        {
        ...
        public void PrecargaJugadores()
        {
            ...
            AltaJugador(new Jugador(775, "16", "Cristian Roldán", DateTime.Parse("1995-06-03 20:00:00"), 1.73, "NDF", 5500000, "EUR", GetPais("Estados Unidos"), "Mediocentro"));
        ...
        {
            AltaPeriodista(new Periodista((1), "Ernesto Gonzales", "ErnestoG27@gmail.com", "EG2790ernesto"));
            AltaPeriodista(new Periodista((2), "Nestor Martinez", "MartinezNestor@gmail.com", "Nestor1980M"));
        }

        private void AltaPeriodista(Periodista periodista)
        {
        ...
        private void AltaPais(Pais pais)
        {
            Paises.Add(pais);
        }
        //**Precarga de selecciones y metodos para poder dar de alta una seleccion**\\
        ...
        private List<Jugador> JugadoresDe(Pais p)
        {
            ...
            foreach (Jugador j in Jugadores)
            {
                ...
                if (j.PaisPertenece.Nombre.Equals(p.Nombre))
                {
                    _misJugadores.Add(j);
                }
            }
        ...
        public Pais ObtenerPaisPorCodigo(string alpha3)
        {
            foreach (Pais p in Paises)
            {
                if (p.Alpha3.Equals(alpha3))
                {
                    return p;
                }
            }
        ...
        public Seleccion ObtenerSeleccionPorPais(string Alpha3)
        {
            foreach (Seleccion s in Selecciones)
            {
                if (s.pais.Alpha3 == Alpha3)
                {
                    return s;
                }
        ...
        //**Fin precarga Seleccion**\\

        public void PrecargaIncidencias()
        {

            AltaIncidencia(GetPartido(1), new Incidencia(GetJugador(1), "Amarilla", 15));
            AltaIncidencia(GetPartido(1), new Incidencia(GetJugador(500), "Expulsado", 40));
            AltaIncidencia(GetPartido(1), new Incidencia(GetJugador(494), "Gol", 76));

            AltaIncidencia(GetPartido(2), new Incidencia(GetJugador(485), "Gol", 32));
            AltaIncidencia(GetPartido(2), new Incidencia(GetJugador(485), "Amarilla", 40));
            AltaIncidencia(GetPartido(2), new Incidencia(GetJugador(33), "Amarilla", 60));

            AltaIncidencia(GetPartido(3), new Incidencia(GetJugador(39), "Amarilla", 10));
            AltaIncidencia(GetPartido(3), new Incidencia(GetJugador(35), "Amarilla", 40));
            AltaIncidencia(GetPartido(3), new Incidencia(GetJugador(42), "Gol", 52));

            AltaIncidencia(GetPartido(4), new Incidencia(GetJugador(21), "Expulsado", 52));
            AltaIncidencia(GetPartido(4), new Incidencia(GetJugador(40), "Gol", 60));
            AltaIncidencia(GetPartido(4), new Incidencia(GetJugador(41), "Amarilla", 76));

            AltaIncidencia(GetPartido(5), new Incidencia(GetJugador(86), "Amarilla", 10));
            AltaIncidencia(GetPartido(5), new Incidencia(GetJugador(98), "Amarilla", 26));
            AltaIncidencia(GetPartido(5), new Incidencia(GetJugador(17), "Expulsado", 35));
            AltaIncidencia(GetPartido(5), new Incidencia(GetJugador(23), "Gol", 50));

            AltaIncidencia(GetPartido(6), new Incidencia(GetJugador(502), "Gol", 52));
            AltaIncidencia(GetPartido(6), new Incidencia(GetJugador(492), "Amarilla", 64));
            AltaIncidencia(GetPartido(6), new Incidencia(GetJugador(95), "Gol", 71));

            AltaIncidencia(GetPartido(7), new Incidencia(GetJugador(780), "Gol", 10));
            AltaIncidencia(GetPartido(7), new Incidencia(GetJugador(792), "Gol", 32));
            AltaIncidencia(GetPartido(7), new Incidencia(GetJugador(785), "Amarilla", 55));

            AltaIncidencia(GetPartido(8), new Incidencia(GetJugador(482), "Gol", 27));
            AltaIncidencia(GetPartido(8), new Incidencia(GetJugador(5), "Amarilla", 36));
            AltaIncidencia(GetPartido(8), new Incidencia(GetJugador(490), "Gol", 63));

            AltaIncidencia(GetPartido(9), new Incidencia(GetJugador(806), "Amarilla", 52));
            AltaIncidencia(GetPartido(9), new Incidencia(GetJugador(719), "Gol", 59));
            AltaIncidencia(GetPartido(9), new Incidencia(GetJugador(801), "Expulsado", 63));

            AltaIncidencia(GetPartido(10), new Incidencia(GetJugador(778), "Amarilla", 43));
            AltaIncidencia(GetPartido(10), new Incidencia(GetJugador(746), "Amarilla", 50));
            AltaIncidencia(GetPartido(10), new Incidencia(GetJugador(781), "Gol", 52));

            AltaIncidencia(GetPartido(11), new Incidencia(GetJugador(783), "Amarilla", 52));
            AltaIncidencia(GetPartido(11), new Incidencia(GetJugador(777), "Amarilla", 80));
            AltaIncidencia(GetPartido(11), new Incidencia(GetJugador(712), "Expulsado", 52));

            AltaIncidencia(GetPartido(12), new Incidencia(GetJugador(797), "Expulsado", 52));
            AltaIncidencia(GetPartido(12), new Incidencia(GetJugador(740), "Amarilla", 70));
            AltaIncidencia(GetPartido(12), new Incidencia(GetJugador(746), "Gol", 87));

            AltaIncidencia(GetPartido(13), new Incidencia(GetJugador(769), "Expulsado", 52));
            AltaIncidencia(GetPartido(13), new Incidencia(GetJugador(760), "Amarilla", 70));
            AltaIncidencia(GetPartido(13), new Incidencia(GetJugador(480), "Gol", 87));

            AltaIncidencia(GetPartido(14), new Incidencia(GetJugador(414), "Expulsado", 52));
            AltaIncidencia(GetPartido(14), new Incidencia(GetJugador(417), "Gol", 70));
            AltaIncidencia(GetPartido(14), new Incidencia(GetJugador(420), "Gol", 87));

            AltaIncidencia(GetPartido(15), new Incidencia(GetJugador(47), "Expulsado", 52));
            AltaIncidencia(GetPartido(15), new Incidencia(GetJugador(96), "Amarilla", 70));
            AltaIncidencia(GetPartido(15), new Incidencia(GetJugador(54), "Gol", -1));

            AltaIncidencia(GetPartido(16), new Incidencia(GetJugador(135), "Gol", 52));
            AltaIncidencia(GetPartido(16), new Incidencia(GetJugador(140), "Amarilla", 70));
            AltaIncidencia(GetPartido(16), new Incidencia(GetJugador(147), "Gol", 87));

            AltaIncidencia(GetPartido(17), new Incidencia(GetJugador(485), "Amarilla", 52));
            AltaIncidencia(GetPartido(17), new Incidencia(GetJugador(54), "Amarilla", 70));
            AltaIncidencia(GetPartido(17), new Incidencia(GetJugador(482), "Gol", 87));

            AltaIncidencia(GetPartido(18), new Incidencia(GetJugador(413), "Amarilla", 52));
            AltaIncidencia(GetPartido(18), new Incidencia(GetJugador(135), "Amarilla", 70));
            AltaIncidencia(GetPartido(18), new Incidencia(GetJugador(136), "Gol", -1));

            AltaIncidencia(GetPartido(19), new Incidencia(GetJugador(145), "Expulsado", 52));
            AltaIncidencia(GetPartido(19), new Incidencia(GetJugador(132), "Amarilla", 70));
            AltaIncidencia(GetPartido(19), new Incidencia(GetJugador(486), "Gol", 87));
        ...
        public void AltaPartido()
        {
            ...
            Partido p1 = new FaseGrupo(1, new List<Seleccion>() { ObtenerSeleccionPorPais("ARG"), ObtenerSeleccionPorPais("URY") }, DateTime.Parse("2022-08-11 13:00:00"), false, ResultadoPartido(), "A");
            Partido p2 = new FaseGrupo(2, new List<Seleccion>() { ObtenerSeleccionPorPais("URY"), ObtenerSeleccionPorPais("QAT") }, DateTime.Parse("2022-08-15 16:00:00"), false, ResultadoPartido(), "A");
            Partido p3 = new FaseGrupo(3, new List<Seleccion>() { ObtenerSeleccionPorPais("QAT"), ObtenerSeleccionPorPais("DNK") }, DateTime.Parse("2022-08-18 13:00:00"), false, ResultadoPartido(), "A");
            Partido p4 = new FaseGrupo(4, new List<Seleccion>() { ObtenerSeleccionPorPais("ARG"), ObtenerSeleccionPorPais("QAT") }, DateTime.Parse("2022-08-20 16:00:00"), false, ResultadoPartido(), "A");
            Partido p5 = new FaseGrupo(5, new List<Seleccion>() { ObtenerSeleccionPorPais("DNK"), ObtenerSeleccionPorPais("ARG") }, DateTime.Parse("2022-08-22 17:00:00"), false, ResultadoPartido(), "A");
            Partido p6 = new FaseGrupo(6, new List<Seleccion>() { ObtenerSeleccionPorPais("URY"), ObtenerSeleccionPorPais("DNK") }, DateTime.Parse("2022-08-25 14:00:00"), false, ResultadoPartido(), "A");

            Partido p7 = new FaseGrupo(7, new List<Seleccion>() { ObtenerSeleccionPorPais("USA"), ObtenerSeleccionPorPais("WLS") }, DateTime.Parse("2022-08-28 18:00:00"), false, ResultadoPartido(), "G");
            Partido p8 = new FaseGrupo(8, new List<Seleccion>() { ObtenerSeleccionPorPais("MEX"), ObtenerSeleccionPorPais("CMR") }, DateTime.Parse("2022-09-01 13:00:00"), false, ResultadoPartido(), "G");
            Partido p9 = new FaseGrupo(9, new List<Seleccion>() { ObtenerSeleccionPorPais("WLS"), ObtenerSeleccionPorPais("CMR") }, DateTime.Parse("2022-09-07 20:00:00"), false, ResultadoPartido(), "G");
            Partido p10 = new FaseGrupo(10, new List<Seleccion>() { ObtenerSeleccionPorPais("MEX"), ObtenerSeleccionPorPais("USA") }, DateTime.Parse("2022-09-10 22:00:00"), false, ResultadoPartido(), "G");
            Partido p11 = new FaseGrupo(11, new List<Seleccion>() { ObtenerSeleccionPorPais("USA"), ObtenerSeleccionPorPais("CMR") }, DateTime.Parse("2022-09-12 10:00:00"), false, ResultadoPartido(), "G");
            Partido p12 = new FaseGrupo(12, new List<Seleccion>() { ObtenerSeleccionPorPais("MEX"), ObtenerSeleccionPorPais("WLS") }, DateTime.Parse("2022-09-15 12:00:00"), false, ResultadoPartido(), "G");

            Partido pE1 = new FaseEliminatoria(13, new List<Seleccion>() { ObtenerSeleccionPorPais("USA"), ObtenerSeleccionPorPais("URY") }, DateTime.Parse("2022-09-25 13:00:00"), false, ResultadoPartido(), true, false, "Cuartos de finales");
            Partido pE2 = new FaseEliminatoria(14, new List<Seleccion>() { ObtenerSeleccionPorPais("JPN"), ObtenerSeleccionPorPais("SEN") }, DateTime.Parse("2022-11-02 16:00:00"), false, ResultadoPartido(), false, false, "Cuartos de finales");
            Partido pE3 = new FaseEliminatoria(15, new List<Seleccion>() { ObtenerSeleccionPorPais("QAT"), ObtenerSeleccionPorPais("DNK") }, DateTime.Parse("2022-11-10 22:00:00"), false, ResultadoPartido(), true, true, "Cuartos de finales");
            Partido pE4 = new FaseEliminatoria(16, new List<Seleccion>() { ObtenerSeleccionPorPais("FRA"), ObtenerSeleccionPorPais("IRN") }, DateTime.Parse("2022-11-16 22:00:00"), false, ResultadoPartido(), false, false, "Cuartos de finales");

            Partido pE5 = new FaseEliminatoria(17, new List<Seleccion>() { ObtenerSeleccionPorPais("URY"), ObtenerSeleccionPorPais("QAT") }, DateTime.Parse("2022-11-22 22:00:00"), false, ResultadoPartido(), true, false, "Semifinales");
            Partido pE6 = new FaseEliminatoria(18, new List<Seleccion>() { ObtenerSeleccionPorPais("FRA"), ObtenerSeleccionPorPais("JPN") }, DateTime.Parse("2022-11-27 22:00:00"), false, ResultadoPartido(), true, true, "Semifinales");

            Partido pE7 = new FaseEliminatoria(19, new List<Seleccion>() { ObtenerSeleccionPorPais("URY"), ObtenerSeleccionPorPais("FRA") }, DateTime.Parse("2022-12-4 22:00:00"), false, ResultadoPartido(), true, false, "Final");
        ...
        public Periodista AltaPeriodista(int id, string nombre, string email, string password)
        {


            Periodista periodista = new Periodista(id, nombre, email, password);
            ...
            foreach (Periodista p in Periodistas)
            {
                ...
                if (p.Id == id)
                {
                    throw new Exception("No pueden haber dos periodistas con el mismo id, Ingrese una contraseña que no exista. \n");
                }
            }
            Periodistas.Add(periodista);
            return periodista;
        ...
        //**FIN PRECARGA Y ALTAS**\\

        //**METODOS PARA SOLUCIONAR REQUERIMIENTOS PEDIDOS**\\
        public List<Jugador> ObtenerJugadoresOrdenados(List<Jugador> jugadores)
        {
        ...
        public void CambiarMontoReferenciaJugador(int monto)
        {

            if (monto > 0)
            {
                Jugador.MontoReferencia = monto;
            }
            else
            {
                throw new Exception("El valor que ingreso no es valido. \n");
            }
        }


        public List<Partido> ObtenerPartidosMasGolesSeleccion(string nombreSeleccion)
        {

            int maxGoles = 0;

            List<Partido> auxiliar = new List<Partido>();
            Seleccion s = ObtenerSeleccionPorNombrePais(nombreSeleccion);
            if (s == null)
            {
                throw new Exception("La selección no existe");
            }
            foreach (Partido p in Partidos)
            {

                if (p.Selecciones.Contains(s))
                {
                    int contador = 0;
                    ...
                    if (contador > maxGoles)
                    {
                        maxGoles = contador;
                        auxiliar.Clear();
                        auxiliar.Add(p);
                    }
                    else if (contador == maxGoles)
                    {
                        auxiliar.Clear();
                        auxiliar.Add(p);
                    }
        ...
        public Seleccion ObtenerSeleccionPorNombrePais(string nombrePais)
        {
            foreach (Seleccion s in Selecciones)
            {
        ...
        private void AltaJugador(Jugador jugador)
        {
        ...
        public List<Partido> JugadorParticipoEnPartido(int id)
        {
            Jugador j = GetJugador(id);
            List<Partido> aux = new List<Partido>();
            if (j == null)
            {
                throw new Exception("El ID que usted ingreso no es valido. Ingrese un ID que este asignado a un jugador. \n");
            }
            foreach (Partido p in Partidos)
            {
        ...
        public string ResultadoPartido()
        {
            ...
            foreach (FaseGrupo fg in Partidos)
            {
                if (fg.Finalizado == true)
                {

                    if (fg.Resultado == "Ganó")
                    {
                        return "Ganador: " + fg.Selecciones;
                    }
                    if (fg.Resultado == "Empate")
                    {
                        return "Empate";
                    }
            ...
            foreach (FaseEliminatoria fe in Partidos)
            {
                if (fe.Finalizado == true)
                {

                    if (fe.Resultado == "Ganó")
                    {
                        return "Ganador: " + fe.Selecciones;
                    }
                    if (fe.Resultado == "Empate en tiempo de juego. Ganador: " + fe.Selecciones + " en tanda de penales.")
                    {
                        return "Empate";
                    }
        ...
        public List<Jugador> ObtenerJugadoresHicieronUnGol(int id)
        {
